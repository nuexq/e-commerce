...
INSERT INTO "new_Product" ("description", "filePath", "id", "isAvailableForPurchase", "name", "priceInCents") SELECT "description", "filePath", "id", "isAvailableForPurchase", "name", "priceInCents" FROM "Product";
DROP TABLE "Product";
